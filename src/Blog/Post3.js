            ...
            <div className="container">
              <div className="row">
                <div className="col-md-12">
                  <img
                    src={process.env.PUBLIC_URL + `/assets/img/slider/3.jpg`}
                    className="mb-30"
                    alt="not found"
                  />
                  <h2 className="section-title2">Postmodern Architecture</h2>
                  <p>
                  ...
                  <div className="col-md-7">
                    <div className="bauen-post-comment-wrap">
                      <div className="bauen-user-comment">
                        ...
                        <img
                          src={
                            process.env.PUBLIC_URL + `/assets/img/team/3.jpg`
                          }
                          alt="not found"
                        />{" "}
                      </div>
                      <div className="bauen-user-content">
                        <h3>
                          Martin Misse<span> 29 October 2022</span>
                        </h3>
                        <p>
