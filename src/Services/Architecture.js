            ...
            <div className="container">
              <div className="row">
                <div className="col-md-12">
                  <h2 className="section-title2">Architecture</h2>
                </div>
              </div>
              <div className="row">
                <div className="col-md-8">
                  ...
                  <div className="row mb-30">
                    <div className="col-md-6 gallery-item">
                      <a
                        href={
                          process.env.PUBLIC_URL + `/assets/img/services/9.jpg`
                        }
                        title="Architecture"
                        className="img-zoom"
                      >
                    ...
                    <div className="col-md-6 gallery-item">
                      <a
                        href={
                          process.env.PUBLIC_URL + `/assets/img/services/10.jpg`
                        }
                        title="Architecture"
                        className="img-zoom"
                      >
                    ...
                    <div className="col-md-12 gallery-item">
                      <a
                        href={
                          process.env.PUBLIC_URL + `/assets/img/services/11.jpg`
                        }
                        title="Architecture"
                        className="img-zoom"
                      >
