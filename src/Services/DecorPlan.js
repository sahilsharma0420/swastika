            ...
            <div className="container">
              <div className="row">
                <div className="col-md-12">
                  <h2 className="section-title2">Decor Plan</h2>
                </div>
              </div>
              <div className="row">
                <div className="col-md-8">
                  <p>
                    Decor plan non lorem ac erat suscipit bibendum. Nulla
                  ...
                  <p>
                    Design gravida eros ut turpis interdum ornare. Interdum et
                    malesu they adamale fames anteipsun pimsinefaucibus urabitur
                    arcu site feugiat in volutpat.
                  </p>
                  <div className="row mb-30">
                    <div className="col-md-6 gallery-item">
                      <a
                        href={
                          process.env.PUBLIC_URL + `/assets/img/services/12.jpg`
                        }
                        title="Decor Plan"
                        className="img-zoom"
                      >
                    ...
                    <div className="col-md-6 gallery-item">
                      <a
                        href={
                          process.env.PUBLIC_URL + `/assets/img/services/13.jpg`
                        }
                        title="Decor Plan"
                        className="img-zoom"
                      >
