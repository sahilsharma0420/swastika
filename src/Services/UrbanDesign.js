            ...
            <div className="container">
              <div className="row">
                <div className="col-md-12">
                  <h2 className="section-title2">Urban Design</h2>
                </div>
              </div>
              <div className="row">
                <div className="col-md-8">
                  <p>
                    Urban design non lorem ac erat suscipit bibendum. Nulla
                  ...
                  <div className="row mb-30">
                    <div className="col-md-6 gallery-item">
                      <a
                        href={
                          process.env.PUBLIC_URL + `/assets/img/services/4.jpg`
                        }
                        title="Urban Design"
                        className="img-zoom"
                      >
                    ...
                    <div className="col-md-6 gallery-item">
                      <a
                        href={
                          process.env.PUBLIC_URL + `/assets/img/services/5.jpg`
                        }
                        title="Urban Design"
                        className="img-zoom"
                      >
                    ...
                    <div className="col-md-12 gallery-item">
                      <a
                        href={
                          process.env.PUBLIC_URL + `/assets/img/services/6.jpg`
                        }
                        title="Urban Design"
                        className="img-zoom"
                      >
