            ...
            <div className="container">
              <div className="row">
                <div className="col-md-12">
                  <h2 className="section-title2">Planning</h2>{" "}
                </div>
              </div>
              <div className="row">
                <div className="col-md-8">
                  <p>
                    Planning non lorem ac erat suscipit bibendum. Nulla facilisi
                  ...
                  <div className="row mb-30">
                    <div className="col-md-12 gallery-item">
                      <a
                        href={
                          process.env.PUBLIC_URL + `/assets/img/services/7.jpg`
                        }
                        title="Planning"
                        className="img-zoom"
                      >
