            ...
            <div className="container">
              <div className="row">
                <div className="col-md-12">
                  <h2 className="section-title2">3D Modelling</h2>
                </div>
              </div>
              <div className="row">
                <div className="col-md-8">
                  <p>
                    3D modelling non lorem ac erat suscipit bibendum. Nulla
                  ...
                  <div className="row mb-30">
                    <div className="col-md-12 gallery-item">
                      <a
                        href={
                          process.env.PUBLIC_URL + `/assets/img/services/8.jpg`
                        }
                        title="3D Modelling"
                        className="img-zoom"
                      >
