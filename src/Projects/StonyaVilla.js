            ...
            <div className="container">
              <div className="row">
                <div className="col-md-12">
                  <h2 className="section-title2">Stonya Villa</h2>
                </div>
              </div>
              <div className="row">
                ...
                <div className="col-md-4">
                  ...
                  <p>
                    <b>Company : </b> OTT International
                  </p>
                  <p>
                    <b>Project Name : </b> Stonya Villa
                  </p>
                  <p>
                    <b>Location : </b> Ottova, Canada
                  </p>
                </div>
              </div>
